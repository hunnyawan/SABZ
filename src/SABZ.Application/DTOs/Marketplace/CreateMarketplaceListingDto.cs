...
/// <summary>
/// Request body for POST /api/marketplace/listings. No ownership fields:
/// the seller always comes from the JWT identity. The price is an
/// informational asking/rental rate only - SABZ never charges anything.
/// </summary>
